...
const TVShowsDetail = ({ id }) => {
    ...
    const getMovieDetails = async () => {
        const response = await api.get(
            `tv/${id}?api_key=${apiKey}&append_to_response=credits,videos,images`
        );
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4 p-5'>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <span>,</span>
                                    <small><i className="fa-solid fa-calendar-days me-1 text-primary-500"></i>{movie.first_air_date}</small>
                                    <span>,</span>
                                    <small>
